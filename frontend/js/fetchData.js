...
//adding a new comments to the posts
...
<div class="postComment-input-field-holder">
...
const handlePostComment = async(postId) =>{
    //collecting logged in user id from local storege
    let user = localStorage.getItem("loggedInUser");
    if(user){
        user = JSON.parse(user);
    }
    const commentedUserId = user.userId;
    //getting comment text from input field
    ...
    try{
        ...
        console.log("Error while standing data to the server:", err);
...
//this finction automatacally runs
fetchAllPosts();
